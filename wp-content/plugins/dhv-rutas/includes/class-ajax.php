...
class DHV_Rutas_Ajax {
    ...
    public function __construct() {
        ...
        // Entrega
        add_action( 'wp_ajax_dhv_update_entrega_status',      array( $this, 'update_entrega_status' ) );
        add_action( 'wp_ajax_dhv_bulk_update_entrega_status', array( $this, 'bulk_update_entrega_status' ) );
    }
    ...
    public function update_entrega_status() {
        $this->verify();
        ...
        $result = DHV_Rutas_DB::update_status( $shipment_id, $new_status, $driver_id, 'entrega' );
    ...
    public function bulk_update_entrega_status() {
        $this->verify();
        ...
        $results = DHV_Rutas_DB::bulk_update_status( $shipment_ids, $new_status, $driver_id, 'entrega' );
        $ok      = array_filter( $results );
